...
//Modified by Matt Filer for ARTSTATION - 02/07/18 & 13/08/18
...
//Converts X,Y position to lat/long coordinates 
...
//Convert X,Y to Lat/Long (UTM)
function ConvertToCoordinates(input_x, input_y)
{                                  
    latlon = new Array(2);
    var x, y, zone, southhemi;
    
    x = parseFloat(input_x);
    y = parseFloat(input_y);

    zone = 30; //covers most of the UK
    southhemi = false; //again, this will need editing if used for a different location...
